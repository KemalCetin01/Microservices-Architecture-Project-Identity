...
public class UpdateB2CUserCommand : UpdateB2CUserCommandDTO, ICommand<B2CUserGetByIdDTO>
{
}

public sealed class B2CUserCommandHandler : BaseCommandHandler<UpdateB2CUserCommand, B2CUserGetByIdDTO>
{
    ...
    public B2CUserCommandHandler(IUserB2CService userB2CService,
    ...
    public override async Task<B2CUserGetByIdDTO> Handle(UpdateB2CUserCommand request, CancellationToken cancellationToken)
    {
        ...
        return await _userB2CService.UpdateAsync(request, cancellationToken);
    }
}

...
public class UserB2BService : IUserB2BService
{
    ...
    public async Task<B2BUserGetByIdDTO> CreateAsync(CreateB2BUserCommandDTO model, CancellationToken cancellationToken)
    {
        ...
        var identityUserResponse = new CreateIdentityUserResponseDto() { };// await _identityB2BService.CreateUserAsync(requestDto, cancellationToken);
        ...
        {
            var isDeleted = false;// await _identityB2BService.DeleteUserAsync(identityUserResponse.IdentityRefId,cancellationToken);
            if (!isDeleted)
            { //Serilog
    ...
    public async Task DeleteAsync(Guid Id, CancellationToken cancellationToken)
    {
        ...
        bool isDeleted = true;// await _identityB2BService.DeleteUserAsync(existUser.User.IdentityRefId, cancellationToken);
